...
/**
 * Tests Redis lock service in failover mode when Redis is available.
 *
 * @group redis
 */
class RedisLockFailoverNotNeededTest extends KernelTestBase {
  ...
  public function testLockFailover() {
    ...
    $this->assertNotInstanceOf('\Drupal\Core\ProxyClass\Lock\DatabaseLockBackend', $this->lock);
    $this->assertNotInstanceOf('\Drupal\Core\ProxyClass\Lock\PersistentDatabaseLockBackend', $this->lockPersistent);
  }
